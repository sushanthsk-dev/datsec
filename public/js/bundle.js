...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"validateForm.js":[function(require,module,exports) {
"use strict";
...
var showError = function showError(errorSpan, text) {
  errorSpan.textContent = text;
  errorSpan.classList.remove(errorSpan.classList[1]);
  errorSpan.classList.add('show-error'); // sendMessage.classList.remove(sendMessage.classList[3]);
};

var hideError = function hideError(errorSpan) {
  // const sendMessage =  document.querySelector('.sendMessage');
  errorSpan.classList.remove(errorSpan.classList[1]);
  errorSpan.classList.add('hide-error'); // sendMessage.classList.add('send-response');
};

var validateForm = function validateForm(data, letters, idName, attr) {
  var errorSpan = document.querySelector(".error".concat(attr));

  if (data) {
    if (!data.match(letters)) {
      var text = idName === 'email' ? 'Please enter a valid email address' : 'Please enter a correct input';
      showError(errorSpan, text);
    } else if (data.length < 5) {
      var _text = 'Please enter atleast 5 character';
      showError(errorSpan, _text);
    } else {
      hideError(errorSpan);
    }
  } else {
    var type;
    if (idName === 'name') type = 'name';else if (idName === 'email') type = 'email';else if (idName === 'subject') type = 'subject';else type = 'message';
    errorSpan.textContent = "Please enter ".concat(type);
    errorSpan.classList.remove(errorSpan.classList[1]);
...
var validate = function validate(e) {
  ...
  var messge = document.getElementById('message').value.trim();
  e.preventDefault();
  var nameLetter = /^[A-Za-z ]+$/;
  var subjectLetter = /^[A-Za-z0-9\\,\\.\\; ]+$/;
  var messageLetter = /^[A-Za-z0-9\\,\\.\\;\\!\\#\\$\\%\\&\\'\\*\\+\\/\\=\\?\\^\\_\\`\\'\\" ]+$/;
  ...
  var errorValidate = document.querySelectorAll('.show-error');
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.custom-alert');
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"custom-alert alert--".concat(type, "\" style=\"transition:ease;\">").concat(msg, "</div>");
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                return location.assign('/admin/blogs');
              });
            }
...
var forgotPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(emailId) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alert.showAlert)('success', 'Reset url sent to email');
              window.setTimeout(function () {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(password, confirmPassword, token) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"popupConfirm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.popupConfirm = void 0;
...
var popupConfirm = function popupConfirm(title, msg, $true, $false, type, id) {
  /*change*/
  var $content = "<div class='dialog-ovelay'>" + "<div class='dialog'><header>" + ' <h3> ' + title + ' </h3> ' + "<i class='fa fa-close'></i>" + '</header>' + "<div class='dialog-msg'>" + ' <p> ' + msg + ' </p> ' + '</div>' + '<footer>' + "<div class='controls'>" + " <button class='button button-danger doAction'>" + $true + '</button> ' + " <button class='button button-default cancelAction'>" + $false + '</button> ' + '</div>' + '</footer>' + '</div>' + '</div>';

  if (!document.querySelector('.dialog-ovelay')) {
    $('body').prepend($content);
    document.body.classList.add('stop-scrolling');
    $('.doAction').click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var url, res;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              url = type === 'blog' ? "/api/v1/blogs/".concat(id) : "/api/v1/response/".concat(id);
              _context.prev = 1;
              _context.next = 4;
              return (0, _axios.default)({
                method: 'DELETE',
            ...
            case 4:
              ...
              if (res.data.status == undefined) {
                if (type === 'blog') (0, _alert.showAlert)('success', 'Blog deleted successfully');else (0, _alert.showAlert)('success', 'Response deleted successfully');
                window.setTimeout(function () {
                  if (type === 'blog') location.assign('/admin/blogs');else location.assign('/admin/response');
                }, 1500);
              }
            ...
            case 8:
              ...
              (0, _alert.showAlert)('error', 'Failed to delete blog. Please try again');
...
exports.popupConfirm = popupConfirm;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"visibilityControl.js":[function(require,module,exports) {
"use strict";
...
var visibilityControl = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Blog visibility changed successfully');
              window.setTimeout(function () {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Error while changing visibility! Try again..');
  ...
  return function visibilityControl(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.visibilityControl = visibilityControl;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"contactResponse.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateBlog = exports.createBlog = exports.contactResponse = void 0;
...
var contactResponse = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Response sent successfully..');
              window.setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Failed to send response.. Please try again!');
  ...
  return function contactResponse(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Blog created');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Blog updated');
              window.setTimeout(function () {
                location.assign('/admin/blogs');
              }, 1000);
            }
...
var _popupConfirm = require("./popupConfirm");

var _visibilityControl = require("./visibilityControl");

var _contactResponse = require("./contactResponse");

var contactForm = document.querySelector('.send-message');
var btnCreateSteps = document.querySelector('.btnCreateSteps');
var loginForm = document.querySelector('.form-user-login');
var forgotPasswordForm = document.querySelector('.form-user-password-forgot');
var resetPasswordForm = document.querySelector('.form-user-password-reset');
var logoutBtn = document.querySelector('.logout-btn');
var btnSaveBlogVisibility = document.querySelectorAll('.btn-save');
var createBlogForm = document.querySelector('.create-blog-form');
var editBlogForm = document.querySelector('.edit-blog-form');
...
if (btnCreateSteps) btnCreateSteps.addEventListener('click', function (e) {
  e.preventDefault();
  var step = document.getElementById('sel1').value;

  for (var i = step; i >= 1; i--) {
    var stepDiv = document.createElement('div');
    var stepLabel = document.createElement('label');
    var wrongIcon = document.createElement('i');
    stepDiv.className = "step-containers step-container".concat(i);
    var br = document.createElement('br');
    var stepDescription = document.createElement('input');
    var stepFile = document.createElement('input');
    stepFile.type = 'file';
    stepFile.className = 'form-control stepImgFile';
    stepFile.name = "stepImgFile".concat(i);
    stepFile.id = "stepImgFile".concat(i);
    stepLabel.for = "stepDescription".concat(i);
    stepLabel.innerText = 'Step Description';
    stepDescription.className = 'form-control';
    stepDescription.type = 'text';
    stepDescription.name = "stepDescription".concat(i);
    stepDescription.id = "stepDescription".concat(i);
    ...
    document.querySelector('.steps').insertAdjacentElement('beforeend', stepDiv);
  }
});

if (document.querySelector('.wrong-icon')) {} // function remove(data) {
...
if (contactForm) {
  contactForm.addEventListener('click', function (e) {
    (0, _validateForm.validate)(e);
    e.preventDefault();

    if (document.querySelector('.send-message').classList[3]) {
      if (document.querySelector('.send-message').classList[3] == 'send-response') {
        var name = document.getElementById('name').value;
        var email = document.getElementById('email').value;
        var subject = document.getElementById('subject').value;
        var message = document.getElementById('message').value;
        e.target.textContent = 'Sending...';
        (0, _contactResponse.contactResponse)(name, email, subject, message);
      }
    }
  });
}

var allBtnDltRes = document.querySelectorAll('.btn-delete-res');
allBtnDltRes.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var id = this.getAttribute('arial-id');
    (0, _popupConfirm.popupConfirm)("Delete Response", 'Are you sure you want to Delete this response', 'Yes', 'Cancel', 'res', id);
  });
});
var allBtnDlt = document.querySelectorAll('.btn-delete');
allBtnDlt.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var id = this.getAttribute('arial-id');
    (0, _popupConfirm.popupConfirm)("Delete blog", 'Are you sure you want to Delete this blog', 'Yes', 'Cancel', 'blog', id);
  });
...
if (btnSaveBlogVisibility) {
  btnSaveBlogVisibility.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var selectedVisibilty = btn.parentElement.querySelector('.select-form-visibility'); // const selectedVisibilty = document.querySelector(
      //   '.select-form-visibility'
      // );

      e.preventDefault(); // const value =
      //   selectedVisibilty.selectedIndex === 0 ? 'private' : 'public';

      var blogVisibility = this.getAttribute('arial-id').split('-')[1];

      if (!(blogVisibility === selectedVisibilty.selectedIndex)) {
        var id = this.getAttribute('arial-id').split('-')[0];
        (0, _visibilityControl.visibilityControl)(id, selectedVisibilty.selectedIndex);
      }
    });
  });
}
...
if (createBlogForm) {
  createBlogForm.addEventListener('submit', function (e) {
    ...
    var imageCover = document.getElementById('blogImage').files[0];
    var content = document.getElementById('content').value;

    if (document.querySelector('.step-containers')) {
      var stepsDescription = new Array();
      var stepsImg = new Array();
      var len = document.querySelectorAll('.stepDescription');
      document.querySelectorAll('.stepDescription').forEach(function (el) {
        stepsDescription.push(el.value);
      });
      document.querySelectorAll('.stepImgFile').forEach(function (el) {
    ...
    if (stepsDescription) {
      stepsDescription.forEach(function (step) {
    ...
    (0, _contactResponse.createBlog)(form);
  });
}

if (document.querySelector('.btnEditBlog')) document.querySelector('.btnEditBlog').addEventListener('click', function (e) {
  e.preventDefault();
  var id = editBlogForm.getAttribute('arial-id');
  var title = document.getElementById('title').value;
  var content = document.getElementById('content').value;
  var imageCover = document.getElementById('blogImage').files[0];
  var form = new FormData();
  ...
  form.append('content', content);
  (0, _contactResponse.updateBlog)(form, id);
});
